        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VnpPayDate = table.Column<DateTime>(type: "timestamp with time zone", maxLength: 14, nullable: true),
                    VnpResponseCode = table.Column<int>(type: "integer", maxLength: 2, nullable: true),
                    VnpResponseDescription = table.Column<string>(type: "text", nullable: true),
                    VnpSecureHash = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ...
                    VnpBankTransactionId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    VnpTransactionDescription = table.Column<string>(type: "text", nullable: true),
                    VnpTransactionId = table.Column<long>(type: "bigint", nullable: true),
                    VnpPaymentMethod = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
